...
export type StorageHash =
  StorageHashBase<'fed2db977606d237dbf6f37531c60be4e7046f877e73f32555595cab7544b285'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly User: {
      ...
      readonly globalName: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    readonly User: {
      ...
      readonly globalName: CodecTypes['pg/text@1']['input'] | null;
...
export namespace Models {
  export type public_User = {
    ...
    globalName: CodecTypes['pg/text@1']['output'] | null;
        ...
        readonly entries: {
          readonly table: {
            readonly User: {
              ...
              indexes: readonly [
                {
                  readonly name: 'User_discordId_key';
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly globalName: { readonly column: 'globalName' };
